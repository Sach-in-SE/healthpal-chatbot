    ...
    <section className="pt-2 px-6 md:px-12 lg:px-24 relative overflow-hidden ">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <TransitionWrapper delay={400} animation="scale-in" className="relative pt-20">
            <div className="relative max-h-[80vh]">
              ...
              <div className="absolute bottom-10 -left-8 glass p-4 rounded-xl shadow-sm z-50 animate-float" style={{ animationDelay: '1s' }}>
